package com.stjerncraft.controlpanel.client.websocket;
...
public class WebSocket {
	...
	public native void close() /*-{
		this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.close();
	}-*/;
	
	public native void close(short code) /*-{
		this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.close(code);
	}-*/;
	
	public native void close(short code, String reason) /*-{
		this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.close(code, reason);
	}-*/;
	
	public native void send(String data) /*-{
		this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.send(data);
	}-*/;
	...
	public native String getUrl() /*-{
		return this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.url;
	}-*/;
	
	public native String getProtocol() /*-{
		return this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.protocol;
	}-*/;
	
	public native Long getBufferedAmount() /*-{
		return this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.bufferedAmount;
	}-*/;
	
	public native String getExtensions() /*-{
		return this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.extensions;
	}-*/;
		
	private native int getJSReadyState() /*-{
		return this.@com.stjerncraft.controlpanel.client.websocket.WebSocket::wsObject.readyState;
	}-*/;
	...
	private native void setupInternalListeners(JavaScriptObject wsObj) /*-{
		...
		wsObj.onopen = function(event) {
			self.@com.stjerncraft.controlpanel.client.websocket.WebSocket::onopen()();
		}
		wsObj.onclose = function(event) {
			self.@com.stjerncraft.controlpanel.client.websocket.WebSocket::onclose(ILjava/lang/String;Z)(event.code, event.reason, event.wasClean);
		}
		wsObj.onerror = function(event) {
			self.@com.stjerncraft.controlpanel.client.websocket.WebSocket::onerror()();
		}
		wsObj.onmessage = function(event) {
			if(event.data instanceof ArrayBuffer)
				self.@com.stjerncraft.controlpanel.client.websocket.WebSocket::onmessage(Lcom/google/gwt/typedarrays/shared/ArrayBuffer;)(event.data);
			if(typeof(event.data) === "string")
				self.@com.stjerncraft.controlpanel.client.websocket.WebSocket::onmessage(Ljava/lang/String;)(event.data);
			else {
				//if(event.data instanceof Blob)
				//We just pass along anything else as a JavaScriptObject, including Blob for now.
				self.@com.stjerncraft.controlpanel.client.websocket.WebSocket::onmessage(Lcom/google/gwt/core/client/JavaScriptObject;)(event.data);
			}
